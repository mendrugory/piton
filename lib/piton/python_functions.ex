defmodule Piton.PythonFunctions do
  ...
  def call(python_port, python_module, python_function, arguments) when is_binary(python_module) do
    call(python_port, String.to_atom(python_module), python_function, arguments)
  end

  def call(python_port, python_module, python_function, arguments) when is_binary(python_function) do
