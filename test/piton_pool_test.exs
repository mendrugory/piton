defmodule PitonPoolTest do
  ...
  test "2 calls to the Pool (Calls == Pool)" do
    ...
    assert(result == [{:ok, 9227465}, {:ok, 9227465}])
  end
  ...
  test "6 calls to the Pool (Calls > Pool)" do
    ...
    assert(result == [{:ok, 9227465}, {:ok, 9227465}, {:ok, 9227465}, {:ok, 9227465}, {:ok, 9227465}, {:ok, 9227465}, {:ok, 9227465}, {:ok, 9227465}, {:ok, 9227465}, {:ok, 9227465}])
  end
